...
class Prefs:
    ...
    _dependencies: list[Requirement] = field(universal_config=UniversalKey.dependencies)
    _optional_dependencies: dict[str, list[Requirement]] = field(
        universal_config=UniversalKey.optional_dependencies
    )
